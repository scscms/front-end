...
- 其他
```
git branch | awk  '$1 == "*"{print $2}'  #获取当前分支名
git name-rev --name-only HEAD #获取当前分支名
git show -s --format=%cn #获取提交者姓名
...
%gs: reflog subject
```
更多参见 [https://git-scm.com/docs/pretty-formats](https://git-scm.com/docs/pretty-formats)
